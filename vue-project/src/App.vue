<template>
  ...
  <!-- <cardVote></cardVote> -->
    ...
    <!-- <buttontest v-for="asd in 3"></buttontest> -->
    <!-- <card-vote v-for="asd in 3"></card-vote> -->
...
import saleCard from "./assets/components/sale_card";
import searchBar from "./assets/components/search_bar.vue";
