<template>
    <div>
        ...
        <section id="first_screen">
            ...
            <img id="first_screen_cake_look" src="../images/cake_design_look.svg" alt="">
            <div id="first_screen_cake_demo">
                <img id="first_screen_cake_front" src="../images/cake_design_cake_demo.png" alt="">
                <img id="first_screen_cake_back" src="../images/cake_design_cake_demo2.png" alt="">
                <!-- <div id="first_screen_cake_back"></div> -->
            </div>
            </div>
            <img id="first_screen_bg" src="../images/cake_design_gb_1.jpg" alt="">
        </section>
         <!-- 開始製作 -->
         <!-- 製作中 -->
         <section id="second_screen">
             ...
             <div id="choose_cake_model">
                 <div id="cake_model_title_box">
                     <img src="../images/button_butter.png" alt="" style="width:30px"><p>選擇糕體</p><img src="../images/button_butter.png" alt="" style="width:30px">
                 </div>
                 <div id="choose_cake_model_box">
                     <button id="left_move" style="z-index:10;">《</button>
                     <div id="choose_cake_model_box_contents">
                         <div>
                            <img class="cake" id="cake_model1" src="../images/cake_design/cake_model1.png" alt="">
                            <img class="cake" id="cake_model2" src="../images/cake_design/cake_model2.png" alt="">
                            <img class="cake" id="cake_model3" src="../images/cake_design/cake_model3.png" alt="">
                            <img id="cake_plate" src="../images/cake_design/plate.png" alt="">
                         </div>
                     </div>
        ...
        div#first_screen_cake{
            ...
            div#first_screen_cake_demo{
                ...
                img#first_screen_cake_back{
                    ...
                    // color:#333;
                    // font-size:1.5rem;
                    // background:url("../images/cake_design_cake_demo2.png") center top repeat;
                    transform:rotateY(180deg);
                }
            }
        }
